  ...
  factory RideModel.rideAndParticipants(Map<String, dynamic> ride, List<dynamic> riders) {
   try {
      return RideModel(
        ...
        departureTime: DateTime.parse(ride['departureTime']),
        ...
        createdAt: DateTime.tryParse(ride['createdAt'] ?? ''),
        updatedAt: DateTime.tryParse(ride['updatedAt'] ?? ''),
        chatRoomId: null, // (ride['chatRoom'] is String) ? ride['chatRoom'] : ride['chatRoom']['id'],
