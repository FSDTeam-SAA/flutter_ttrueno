...
//   const BaggageChangeSheet({super.key, required this.initialSelectedBaggage, required String initialSelected});
...
class BaggageChangeSheet extends StatefulWidget {
  ...
  const BaggageChangeSheet({super.key, required this.initialSelected, required Set<String> initialSelectedBaggage});
...
class _BaggageChangeSheetState extends State<BaggageChangeSheet> {
  late String selectedBaggage;

  @override
  void initState() {
    super.initState();
    selectedBaggage = widget.initialSelected;
  }

  void selectBaggage(String type) {
    setState(() {
          ...
          Row(
            ...
            children: [
              _buildBaggageImage(
                imagePath: 'assets/images/largebaggage.png',
                label: 'Large',
                isSelected: selectedBaggage == 'Large',
                onTap: () => selectBaggage('Large'),
              ),
              _buildBaggageImage(
                imagePath: 'assets/images/smallbaggage.png',
                label: 'Small',
                isSelected: selectedBaggage == 'Small',
                onTap: () => selectBaggage('Small'),
              ),
              _buildBaggageImage(
                imagePath: 'assets/images/empty.png',
                label: 'None',
                isSelected: selectedBaggage == 'Empty',
                onTap: () => selectBaggage('Empty'),
              ),
            ],
          ),
          const SizedBox(height: 24),
              ...
              Expanded(
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    Navigator.pop(context, selectedBaggage);
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.green,
                  ),
